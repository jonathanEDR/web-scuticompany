...
const ThemeConfigSection: React.FC<ThemeConfigSectionProps> = ({
  ...
  <div className="flex-1 min-w-0 w-full bg-gradient-to-br from-yellow-50 to-orange-50 p-4 rounded-lg border border-yellow-200">
          <div className="flex items-center mb-3">
            ...
            <div>
              <h3 className="text-lg font-bold text-gray-800">🌞 Tema Claro</h3>
            ...
            <div className="min-w-0">
              ...
              <div className="flex gap-2">
                ...
                <input
                  ...
                  value={pageData.theme?.lightMode?.primary || '#8B5CF6'}
                  onChange={(e) => updateThemeColor('lightMode', 'primary', e.target.value)}
                  className="w-full min-w-0 flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:ring-1 focus:ring-blue-500 focus:border-transparent text-sm bg-white"
                  placeholder="#8B5CF6"
                />
              </div>
            </div>
  ...
  <div className="flex-1 min-w-0 w-full bg-gradient-to-br from-slate-900 to-gray-900 p-4 rounded-lg border border-gray-700">
          <div className="flex items-center mb-3">
            ...
            <div className="min-w-0">
              <h3 className="text-lg font-bold text-white">🌙 Tema Oscuro</h3>
            ...
            <div>
              ...
              <div className="flex gap-2">
                ...
                <input
                  ...
                  value={pageData.theme?.darkMode?.primary || '#A78BFA'}
                  onChange={(e) => updateThemeColor('darkMode', 'primary', e.target.value)}
                  className="w-full min-w-0 flex-1 px-3 py-2 border border-gray-600 rounded-lg focus:ring-1 focus:ring-blue-500 focus:border-transparent bg-gray-800 text-white text-sm"
                  placeholder="#A78BFA"
                />
              </div>
            </div>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-2 gap-8 mt-8 w-full">
          {/* Tema Claro */}
          <div className="flex-1 min-w-0 w-full bg-gradient-to-br from-yellow-50 to-orange-50 p-4 rounded-lg border border-yellow-200 min-w-0">
            <div className="flex items-center mb-3">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-800 min-w-0">🔘 Botones (Tema Claro)</h3>
          ...
          {/* Tema Oscuro */}
          <div className="flex-1 min-w-0 w-full bg-gradient-to-br from-gray-800 to-gray-900 p-4 rounded-lg border border-gray-700 min-w-0">
            <div className="flex items-center mb-3">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-100 min-w-0">🔘 Botones (Tema Oscuro)</h3>
